                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setWeatherData({ ...weatherData, elevation: parseFloat(e.target.value) })}
                                    className="w-full border p-2 rounded text-sm font-mono border-orange-200 bg-orange-50 focus:ring-orange-500"
                                />
                            </div>
